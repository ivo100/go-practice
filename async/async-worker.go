...
import (
	"bitbucket.org/beneregistry/boa-rcp-cs-connector/pkg/api/external/profile/gen/pkg/api/external/profile"
	"bitbucket.org/beneregistry/boa-rcp-cs-connector/pkg/api/gen/pkg/api"
	"bitbucket.org/beneregistry/boa-rcp-cs-connector/pkg/common"
	"bitbucket.org/beneregistry/boa-rcp-cs-connector/pkg/services"
